...
/**
 * The block items. rsmbac adds no items of its own -- everything it registers is something you place.
 */
public final class RsmcItems {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(RSMBAC.MODID);
    /**
