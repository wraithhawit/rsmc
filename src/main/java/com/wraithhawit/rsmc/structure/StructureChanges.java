...
/**
 * A counter bumped whenever any rsmc block is placed or removed, anywhere.
 *
 * <h2>Why this is not the state machine the design forbids</h2>
 *
 * <p>rsmc deliberately keeps <b>no belief about the structure</b> -- see issue #3. Reborn
 ...
 * positive is "someone changed an rsmc block in another dimension, so this controller rescans
